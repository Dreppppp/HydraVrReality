...
export default function Footer() {
  return (
    <div className="w-full h-[350px] bg-[#302C42] flex items-center justify-center relative">
      <div className="absolute left-[0px] top-[-230px] z-0 hidden lg:block">
        <FooterTopIcon />
      </div>
      <div className="absolute left-[0px] top-[0px] z-0 hidden lg:block">
        <FoooterBottomVectorIcon />
      </div>
      <div className="relative z-10 w-[1200px] lg:grid lg:grid-cols-[auto_1px_auto_1px_auto_1px_auto] lg:items-center lg:gap-10">
        ...
        <div className="ml-[70px] flex flex-col gap-3 items-start hidden lg:block">
        ...
        <div className="h-[196px] w-[3px] bg-gradient-to-t from-[#343045] via-[#C0B7E8] to-[#343045 hidden lg:block]"></div>
        <div className="flex flex-col gap-3 items-start hidden lg:block">
          ...
          <button className="text-white text-[16px] font-bold">LICENSES</button>
        </div>
        <div className="h-[196px] w-[3px] bg-gradient-to-t from-[#343045] via-[#C0B7E8] to-[#343045] hidden lg:block"></div>
